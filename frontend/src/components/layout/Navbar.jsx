...
export function Navbar({ title, onMenuClick }) {
  ...
  return (
    <div className="h-16 border-b border-slate-800 bg-slate-900/50 backdrop-blur-md sticky top-0 z-40 flex items-center justify-between px-4 sm:px-6 lg:px-10">
          ...
          {isDropdownOpen && (
            ...
            >
              <div className="p-4 border-b border-white/5 bg-white/5">
                ...
                <p className="text-sm font-bold text-white truncate">{profile?.full_name || "Profile"}</p>
              </div>
